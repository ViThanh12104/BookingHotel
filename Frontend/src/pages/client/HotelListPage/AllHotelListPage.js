// src/pages/client/AllHotelListPage/AllHotelListPage.js
// layout giống Booking.com hơn

import React, { Component } from "react";
import { withRouter } from "react-router-dom";
import HomeHeader from "../HomeHeader";
import homeService from "../../../services/homeService";
import "./AllHotelListPage.scss";

class AllHotelListPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hotels: [],
    ...
    async componentDidMount() {
        ...
        if (city) {
            this.setState({ city });
            await this.fetchHotelsByCity(city);
        } else {
            await this.fetchAllHotels(); // 🔥 thêm
        }
        this.setState({
            minPrice: 0,
            maxPrice: 999999999
    ...
    // SỬA fetchHotelsByCity()

    fetchHotelsByCity = async (city) => {
        try {
            let res = await homeService.getHotelsByCity(city);
            ...
            console.log("Fetch hotels by city error:", e);
        }
    };
    ...
    // phần sort giống Booking.com
    // thêm vào AllHotelListPage.js
...
export default withRouter(AllHotelListPage);